...
export default function StaffReapplyCategories() {
  return (
    <div className="grid max-h-full h-screen w-screen max-w-screen grid-cols-1 justify-evenly lg:grid-cols-2">
      {/* Requirments */}
      <div className="flex flex-col bg-white p-10 py-18 text-black lg:h-screen max-h-full max-w-full">
        <div className="flex flex-col">

          <div className="mt-4">
            <div className="text-xl font-bold underline">Requirements for Re-Applying</div>
          ...
          <div className="pl-10 mt-2 text-medium font-medium">
                <li className="text-medium font-medium"> If you apply for 2 or more positions, you will be paid for only one position even if you are selected for more than one position. You will be able to select the position you want to be paid for when you are selected.</li>
            </div>
          </div>
        </div>
      </div>
