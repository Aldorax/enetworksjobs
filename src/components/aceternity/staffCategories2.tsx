...
export function StaffCategories2() {
  return (
...
const items = [
  {
    ...
    href: "/apply/openings/staff/re-apply/categories/state-govt-office"
  },
  {
    ...
    href: "/apply/openings/staff/re-apply/categories/state-ngo-desk"
  },
  {
    ...
    href: "/apply/openings/staff/re-apply/categories/local-govt-office"
  },
  {
    ...
    className: "md:col-span-1 border border-black",
    icon: <IconSignature className="h-4 w-4 text-neutral-500" />,
    href: "/apply/openings/staff/re-apply/categories/local-ngo-desk"
  }
];
